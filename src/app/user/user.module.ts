...
import { UserRegisterFormComponent } from '../smart-components/forms/user-register-form/user-register-form.component';
import {UserService} from "../services/user.service";
import {FormsModule, ReactiveFormsModule} from '@angular/forms';
import { UserLoginFormComponent } from '../smart-components/forms/user-login-form/user-login-form.component';
