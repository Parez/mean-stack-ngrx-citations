...
var TestUsersDB_1 = require("../user/TestUsersDB");
...
var UserService = (function () {
    ...
    UserService.prototype.signUp = function (registerCred) {
        ...
        return this.http.post(this.usersUrl + 'signup', registerCred, this.options).map(function (response) {
            ...
            if (response.headers.has('x-auth')) {
                ...
                return _.pick(response.json(), ["name", "username", "email", "followers", "rank", "_id"]);
            }
            return null;
        });
    };
    ...
    UserService.prototype.getUserById = function (id) {
        return this.http.get(this.usersUrl + id).map(function (response) {
            return response.json();
        });
